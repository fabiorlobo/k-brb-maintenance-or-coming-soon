	...
	<div class="meta-box-sortables">
		...
		<div class="postbox">
			...
			<div class="inside">
				...
				<p><a href="https://wordpress.org/plugins/k-brb" class="button" target="_blank"><?php esc_html_e('Read more', 'k-brb' ); ?></a></p>
			</div>
		</div>
		...
		<div class="postbox">
			...
			<div class="inside">
				...
				<p><?php esc_html_e('If you have seen any bugs,', 'k-brb' ); ?> <a href="https://github.com/fabiorlobo/k-brb/issues" target="_blank"><?php esc_html_e('please let me know!', 'k-brb' ); ?></a></p>
				...
				<ul>
					<li><a href="https://www.portofacil.net/?ref=1" target="_blank">PortoFácil</a></li>
		...
		<a href="http://alkteia.net" target="_blank"><img class="k" src="<?php echo plugin_dir_url( __FILE__ ) . 'assets/img/k.svg'; ?>" alt="alKteia"></a>
